...
description: |
  ...
  The CSV files are already cached at /home/shapor/.repovet/cache/github.com/<owner>/<repo>/.
...
```
/home/shapor/.repovet/cache/{repo-name}/
...
```bash
REPO=/path/to/repo
CACHE=/home/shapor/.repovet/cache/$(basename $REPO)
mkdir -p "$CACHE"
...
```bash
CACHE=/home/shapor/.repovet/cache/harbor
